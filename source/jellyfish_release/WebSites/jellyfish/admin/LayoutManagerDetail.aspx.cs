...
/// <summary>
/// Administration API - Layout Manager Detail Class
/// </summary>
public partial class admin_LayoutManagerDetail : WebFormBase
{
    /// <summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            updateDetailForm();
            showDZPreview(userSessionEntity.UserID, userSessionEntity.TargetLId);
        }
    ...
    private void updateDetailForm()
    {
        ...
        LayoutInfoEntity entity = dao.GetLayoutInfoByLId(userSessionEntity.UserID,
    ...
    protected void btnCommit_Click(object sender, EventArgs e)
    {
        ...
        if (entity != null)
        {
            ...
            dao.UpdateLayoutInfoByEntity(entity);
        }

        //updateDetailForm();
        String url = ConfigurationManager.AppSettings["LayoutManagerListURL"].ToString();
