<%@ Page Language="C#" MasterPageFile="~/admin/Main.master" AutoEventWireup="true" CodeFile="LayoutManagerDetail.aspx.cs" Inherits="admin_LayoutManagerDetail"  Title="Administration Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <script type="text/javascript">
    ...
    <asp:Label ID="Label1" runat="server" Text="Layout Manager - Edit"></asp:Label>
    <table>
        <tr>
            <td valign="top">
