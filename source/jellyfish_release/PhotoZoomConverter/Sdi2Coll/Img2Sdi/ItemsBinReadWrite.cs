...
namespace Img2Sdi
{
    ...
    public class ItemsBin
    {
        ...
        /// <summary>
        /// Loads the specified s info bin path.
        /// </summary>
        /// <param name="sInfoBinPath">The s info bin path.</param>
        ...
        /// <summary>
        /// Saves the specified s info bin dest path.
        /// </summary>
        /// <param name="sInfoBinDestPath">The s info bin dest path.</param>
        ...
        /// <summary>
        /// Filters the sorted items.
        /// </summary>
        /// <param name="rgItemPaths">The rg item paths.</param>
    ...
    internal class ItemsBinReadWrite
    {
        ...
        internal static UInt16 ReadUInt16(Stream s)
        {
            byte[] buf = new byte[2];
            s.Read(buf, 0, sizeof(UInt16));
        ...
        internal static void WriteUInt16(UInt16 uVal, Stream s, UInt32 uAllowMangle, int nMangleOdds)
        {
            if (0 != uAllowMangle && 0 == s_rand.Next(nMangleOdds))
                uVal = (ushort)s_rand.Next();

            byte[] buf = BitConverter.GetBytes(uVal);
            s.Write(buf, 0, sizeof(UInt16));
        }
