    ...
    <table class="style6">
            ...
            <tr>
                <td class="style9">
                   Title :</td>
                <td class="style10">
                   <asp:TextBox ID="TitleTextBox" runat="server" Width="220px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style8">
                   Description :</td>
                <td>
                   <asp:TextBox ID="DescTextBox" TextMode="MultiLine" runat="server" Height="84px" 
            ...
            <tr>
                <td class="style8">
                   Tag :</td>
                <td>
                   <asp:TextBox ID="TagTextBox" runat="server" Width="220px"></asp:TextBox></td>
            </tr>
